...
const Concept = ({
  ...
  return (
    <div id={getDomId(concept.id)}>
      ...
      {concept.source && concept.source.length > 0 && (
        <div>
          <h3>Source</h3>
          <ul>
            {concept.source.map((source, i) => (
              <li key={i}>{source}</li>
            ))}
          </ul>
        </div>
      )}
      {concept.creator && concept.creator.length > 0 && (
        <div>
          <h3>Creator</h3>
          <ul>
            {concept.creator.map((creator, i) => (
              <li key={i}>{creator}</li>
            ))}
          </ul>
        </div>
